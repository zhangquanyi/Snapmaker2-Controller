...
#define MODULE_SUPPORT_MESSAGE_ID_MAX (200)
...
const uint8_t module_prio_table[][2] = {
  ...
  {/* MODULE_FUNC_SET_FAN1            */  MODULE_FUNC_PRIORITY_MEDIUM,    2 + 5},
  {/* MODULE_FUNC_SET_FAN2            */  MODULE_FUNC_PRIORITY_MEDIUM,    2},
  {/* MODULE_FUNC_SET_3DP_PID         */  MODULE_FUNC_PRIORITY_MEDIUM,    2},
  {/* MODULE_FUNC_SET_CAMERA_POWER    */  MODULE_FUNC_PRIORITY_MEDIUM,    1 + 5},
  {/* MODULE_FUNC_SET_LASER_FOCUS     */  MODULE_FUNC_PRIORITY_MEDIUM,    1 + 5},
  {/* MODULE_FUNC_GET_LASER_FOCUS     */  MODULE_FUNC_PRIORITY_MEDIUM,    1 + 5},
  ...
  {/* MODULE_FUNC_SET_AUTOFOCUS_LIGHT    */  MODULE_FUNC_PRIORITY_MEDIUM, 1 + 5},
  {/* MODULE_FUNC_REPORT_SECURITY_STATUS */  MODULE_FUNC_PRIORITY_MEDIUM, 1 + 5},
  {/* MODULE_FUNC_ONLINE_SYNC            */  MODULE_FUNC_PRIORITY_MEDIUM, 1 + 5},
  {/* MODULE_FUNC_SET_PROTECT_TEMP       */  MODULE_FUNC_PRIORITY_MEDIUM, 1 + 5},
  {/* MODULE_FUNC_LASER_CTRL        */  MODULE_FUNC_PRIORITY_MEDIUM,      1 + 5},
  {/* MODULE_FUNC_GET_HW_VERSION        */  MODULE_FUNC_PRIORITY_MEDIUM,  1 + 5},
  {/* MODULE_FUNC_REPORT_PIN_STATE   */  MODULE_FUNC_PRIORITY_MEDIUM,     1 + 5},
  {/* MODULE_FUNC_CONFIRM_PIN_STATE  */  MODULE_FUNC_PRIORITY_MEDIUM,     1 + 5},
  ...
  {/* MODULE_FUNC_SET_CROSSLIGHT                    */  MODULE_FUNC_PRIORITY_LOW, 6},
  {/* MODULE_FUNC_GET_CROSSLIGHT_STATE              */  MODULE_FUNC_PRIORITY_LOW, 6},
  {/* MODULE_FUNC_SET_FIRE_SENSOR_SENSITIVITY       */  MODULE_FUNC_PRIORITY_MEDIUM, 6},
  {/* MODULE_FUNC_GET_FIRE_SENSOR_SENSITIVITY       */  MODULE_FUNC_PRIORITY_MEDIUM, 6},
  {/* MODULE_FUNC_SET_FIRE_SENSOR_REPORT_TIME       */  MODULE_FUNC_PRIORITY_LOW, 6},
  {/* MODULE_FUNC_REPORT_FIRE_SENSOR_RAWDATA        */  MODULE_FUNC_PRIORITY_LOW, 6},
  {/* MODULE_FUNC_SET_CROSSLIGHT_OFFSET             */  MODULE_FUNC_PRIORITY_MEDIUM, 6},
  {/* MODULE_FUNC_GET_CROSSLIGHT_OFFSET             */  MODULE_FUNC_PRIORITY_MEDIUM, 6},
  {/* MODULE_FUNC_LASER_BRANCH_CTRL                 */  MODULE_FUNC_PRIORITY_MEDIUM, 6},
};
...
class ModuleBase {
  public:
    ...
    uint16_t device_id(uint16_t dev_id) { return device_id_ = dev_id; }
